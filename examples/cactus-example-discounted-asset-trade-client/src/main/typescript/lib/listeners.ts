...
/**
 * Method to accept credential or decline it when error occured.
 *
...
/**
 * Method to accept proof requests or decline it when error occured or matching credential is missing.
 *
 * @param agent Aries agent
