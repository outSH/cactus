...
--
-- Name: fabric; Type: SCHEMA; Schema: -; Owner: postgres
--
...
--
-- Name: get_missing_blocks_in_range(integer, integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.get_missing_blocks_in_range(start_number integer, end_number integer) RETURNS TABLE(block_number integer)
    LANGUAGE plpgsql
    AS $$
BEGIN
  RETURN query
...
ALTER FUNCTION public.get_missing_blocks_in_range(start_number integer, end_number integer) OWNER TO postgres;

--
-- Name: refresh_token_erc20(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.refresh_token_erc20() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
ALTER FUNCTION public.refresh_token_erc20() OWNER TO postgres;

--
-- Name: update_issued_erc721_tokens(numeric); Type: PROCEDURE; Schema: public; Owner: postgres
--

CREATE PROCEDURE public.update_issued_erc721_tokens(IN from_block_number numeric)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER PROCEDURE public.update_issued_erc721_tokens(IN from_block_number numeric) OWNER TO postgres;
...
--
-- Name: token_metadata_erc20; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.token_metadata_erc20 OWNER TO postgres;

--
-- Name: token_transfer; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.token_transfer OWNER TO postgres;

--
-- Name: COLUMN token_transfer.value; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.token_transfer.value IS 'ERC20 - token quantity, ERC721 - token ID';
...
--
-- Name: erc20_token_history_view; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.erc20_token_history_view AS
 SELECT tx.hash AS transaction_hash,
   ...
   FROM (((public.transaction tx
     JOIN public.block b ON ((tx.block_number = b.number)))
     JOIN public.token_transfer tt ON ((tx.id = tt.transaction_id)))
     JOIN public.token_metadata_erc20 tkn ON ((tx."to" = tkn.address)))
  ORDER BY b.created_at, tt.recipient;


ALTER TABLE public.erc20_token_history_view OWNER TO postgres;

--
-- Name: token_metadata_erc721; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.token_metadata_erc721 OWNER TO postgres;

--
-- Name: erc721_token_history_view; Type: VIEW; Schema: public; Owner: postgres
--
...
CREATE VIEW public.erc721_token_history_view AS
 SELECT tx.hash AS transaction_hash,
   ...
   FROM (((public.transaction tx
     JOIN public.block b ON ((tx.block_number = b.number)))
     JOIN public.token_transfer tt ON ((tx.id = tt.transaction_id)))
     JOIN public.token_metadata_erc721 tkn ON ((tx."to" = tkn.address)))
  ORDER BY b.created_at, tt.recipient;


ALTER TABLE public.erc721_token_history_view OWNER TO postgres;

--
-- Name: token_erc721; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.token_erc721 (
    id uuid DEFAULT extensions.uuid_generate_v4() NOT NULL,
    account_address text NOT NULL,
    token_address text NOT NULL,
    uri text NOT NULL,
    token_id numeric NOT NULL,
    last_owner_change timestamp without time zone DEFAULT now() NOT NULL
);


ALTER TABLE public.token_erc721 OWNER TO postgres;

--
-- Name: erc721_txn_meta_view; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.erc721_txn_meta_view AS
 SELECT token_erc721.account_address,
    token_erc721.token_address,
    token_erc721.uri,
    token_metadata_erc721.symbol
   FROM (public.token_erc721
     LEFT JOIN public.token_metadata_erc721 ON ((token_erc721.token_address = token_metadata_erc721.address)));


ALTER TABLE public.erc721_txn_meta_view OWNER TO postgres;

--
-- Name: plugin_status; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.plugin_status (
    name text NOT NULL,
...
ALTER TABLE public.plugin_status OWNER TO postgres;

--
-- Name: token_erc20; Type: MATERIALIZED VIEW; Schema: public; Owner: postgres
--

CREATE MATERIALIZED VIEW public.token_erc20 AS
 SELECT balances.account_address,
   ...
   FROM (( SELECT balances_1.account_address,
            balances_1.token_address,
           ...
           FROM ( SELECT erc20_token_history_view.recipient AS account_address,
                   ...
                   FROM public.erc20_token_history_view
                ...
                UNION
                 SELECT erc20_token_history_view.sender AS account_address,
                    ...
                    (- sum(erc20_token_history_view.value)) AS balance
                   FROM public.erc20_token_history_view
                  GROUP BY erc20_token_history_view.token_address, erc20_token_history_view.sender) balances_1
          GROUP BY balances_1.token_address, balances_1.account_address
         HAVING (sum(balances_1.balance) >= (0)::numeric)) balances
     JOIN public.token_metadata_erc20 metadata ON ((balances.token_address = metadata.address)))
  WITH NO DATA;


ALTER TABLE public.token_erc20 OWNER TO postgres;
...
--
-- Name: block block_hash_key; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: block block_number_key; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: block block_pkey; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: certificate certifiate_pem_unique; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: certificate certifiate_pk; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: certificate certifiate_serial_number_unique; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: transaction_action_endorsement transaction_action_endorsements_pkey; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: transaction_action transaction_action_pkey; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: transaction transaction_hash_key; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: transaction transaction_pkey; Type: CONSTRAINT; Schema: fabric; Owner: postgres
--
...
--
-- Name: plugin_status plugin_status_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.plugin_status
    ADD CONSTRAINT plugin_status_pkey PRIMARY KEY (name);


--
-- Name: token_metadata_erc20 token_erc20_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.token_metadata_erc20
    ADD CONSTRAINT token_erc20_pkey PRIMARY KEY (address);


--
-- Name: token_erc721 token_erc721_contract_tokens_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.token_erc721
    ADD CONSTRAINT token_erc721_contract_tokens_unique UNIQUE (token_address, token_id);


--
-- Name: token_metadata_erc721 token_erc721_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.token_metadata_erc721
    ADD CONSTRAINT token_erc721_pkey PRIMARY KEY (address);


--
-- Name: token_erc721 token_erc721_pkey1; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.token_erc721
    ADD CONSTRAINT token_erc721_pkey1 PRIMARY KEY (id);


--
-- Name: token_transfer token_transfer_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.token_transfer
    ADD CONSTRAINT token_transfer_pkey PRIMARY KEY (id);


--
-- Name: transaction transaction_hash_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: block_hash_unique_idx; Type: INDEX; Schema: fabric; Owner: postgres
--
...
--
-- Name: block_number_unique_idx; Type: INDEX; Schema: fabric; Owner: postgres
--
...
--
-- Name: certifiate_unique_idx; Type: INDEX; Schema: fabric; Owner: postgres
--

CREATE UNIQUE INDEX certifiate_unique_idx ON fabric.certificate USING btree (serial_number);


--
-- Name: transaction_unique_idx; Type: INDEX; Schema: fabric; Owner: postgres
--

CREATE UNIQUE INDEX transaction_unique_idx ON fabric.transaction USING btree (hash);


--
-- Name: token_erc20_account_address_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX token_erc20_account_address_idx ON public.token_erc20 USING btree (account_address);
...
--
-- Name: token_transfer refresh_token_erc20_on_token_transfers_trigger; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER refresh_token_erc20_on_token_transfers_trigger AFTER INSERT OR DELETE OR UPDATE ON public.token_transfer FOR EACH STATEMENT EXECUTE FUNCTION public.refresh_token_erc20();
...
--
-- Name: token_erc721 token_erc721_token_address_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.token_erc721
    ADD CONSTRAINT token_erc721_token_address_fkey FOREIGN KEY (token_address) REFERENCES public.token_metadata_erc721(address);


--
-- Name: token_transfer token_transfer_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.token_transfer
    ADD CONSTRAINT token_transfer_transaction_id_fkey FOREIGN KEY (transaction_id) REFERENCES public.transaction(id);


--
-- Name: transaction transaction_block_number_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.transaction
    ADD CONSTRAINT transaction_block_number_fkey FOREIGN KEY (block_number) REFERENCES public.block(number);
...
--
-- Name: FUNCTION get_missing_blocks_in_range(start_number integer, end_number integer); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.get_missing_blocks_in_range(start_number integer, end_number integer) TO anon;
GRANT ALL ON FUNCTION public.get_missing_blocks_in_range(start_number integer, end_number integer) TO authenticated;
GRANT ALL ON FUNCTION public.get_missing_blocks_in_range(start_number integer, end_number integer) TO service_role;


--
-- Name: FUNCTION refresh_token_erc20(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.refresh_token_erc20() TO anon;
GRANT ALL ON FUNCTION public.refresh_token_erc20() TO authenticated;
GRANT ALL ON FUNCTION public.refresh_token_erc20() TO service_role;


--
-- Name: PROCEDURE update_issued_erc721_tokens(IN from_block_number numeric); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON PROCEDURE public.update_issued_erc721_tokens(IN from_block_number numeric) TO anon;
GRANT ALL ON PROCEDURE public.update_issued_erc721_tokens(IN from_block_number numeric) TO authenticated;
GRANT ALL ON PROCEDURE public.update_issued_erc721_tokens(IN from_block_number numeric) TO service_role;
GRANT ALL ON PROCEDURE public.update_issued_erc721_tokens(IN from_block_number numeric) TO supabase_admin;
...
--
-- Name: TABLE token_metadata_erc20; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE token_transfer; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE erc20_token_history_view; Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON TABLE public.erc20_token_history_view TO supabase_admin;


--
-- Name: TABLE token_metadata_erc721; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE erc721_token_history_view; Type: ACL; Schema: public; Owner: postgres
--
...
GRANT ALL ON TABLE public.erc721_token_history_view TO supabase_admin;


--
-- Name: TABLE token_erc721; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE erc721_txn_meta_view; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE plugin_status; Type: ACL; Schema: public; Owner: postgres
--
...
--
-- Name: TABLE token_erc20; Type: ACL; Schema: public; Owner: postgres
--
