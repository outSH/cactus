...
const ledgerImageName = "outsh/cactus-corda-4-8-all-in-one-obligation";
const ledgerImageVersion = "2022-03-31-2dd619d";
...
const kotlinServerImageName =
  "outsh/cactus-connector-corda-server:2022-03-31-2dd619d";
const kotlinServerImageVersion = "2022-03-31-2dd619d";
...
describe("Monitor Tests", () => {
  ...
  beforeAll(async () => {
    ...
    const ledgerContainer = await ledger.start(true); // TODO - start(False)
    ...
    await connector.start(true); // TODO - start(False)
