...
export class PluginLedgerConnectorIroha2
  ...
  public getQueryContext(
    ...
    switch (query) {
      // TODO - bind this? In client or here?
   ...
   * To send query request you must provide either signed query transaction payload or query description with signingCredential.
   *
   * @param req Request object.
